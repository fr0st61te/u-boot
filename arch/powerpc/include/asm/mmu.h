...
#define EPN(e)		((e) & TLB_WORD0_EPN_MASK)
#define TLB0(epn,sz)	((EPN((epn)) | (sz) | TLB_VALID ))
#define TLB1(rpn,erpn)	(((rpn) & TLB_WORD1_RPN_MASK) | (erpn))
...
+----------------------------------------------------------------------------*/
#define TLB_1G_ALIGN_MASK    0xFC0000000ULL
...
#define TLB_WORD0_TS_MASK    0x00000400
#define TLB_WORD0_TS_1       0x00000400
#define TLB_WORD0_TS_0       0x00000000
#define TLB_WORD0_SIZE_MASK  0x000003F0
#define TLB_WORD0_SIZE_4KB   0x00000000
#define TLB_WORD0_SIZE_16KB  0x00000010
#define TLB_WORD0_SIZE_64KB  0x00000030
#define TLB_WORD0_SIZE_256KB 0x00000040
#define TLB_WORD0_SIZE_1MB   0x00000070
...
#define TLB_WORD1_ERPN_ENCODE(n) ((((unsigned long)(n))&TLB_WORD1_ERPN_MASK)<<0)
#define TLB_WORD1_ERPN_DECODE(n) ((((unsigned long)(n))>>0)&TLB_WORD1_ERPN_MASK)
